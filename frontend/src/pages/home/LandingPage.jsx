...
const HeroSection = lazy(() => import("../../components/landing/HeroSection.jsx"));
const FeaturesSection = lazy(() => import("../../components/landing/FeaturesSection.jsx"));
const ActorsSection = lazy(() => import("../../components/landing/ActorsSection.jsx"));
const MissionSection = lazy(() => import("../../components/landing/MissionSection.jsx"));
const BenefitsSection = lazy(() => import("../../components/landing/BenefitsSection.jsx"));
      ...
      >
        <div className="flex items-center justify-between px-4 py-4 md:px-8 lg:px-12 max-w-7xl mx-auto">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            >
              <Link to="/login">
                <Button type="text" className="text-gray-700 hover:text-teal-600">
                  Connexion
                </Button>
              </Link>
              <Link to="/register">
                <Button type="primary" className="bg-teal-600 hover:bg-teal-700 border-teal-600">
                  Créer un compte
                </Button>
              </Link>
              <Link to="/demande-devis">
                <Button type="default" className="border-teal-600 text-teal-600 hover:bg-teal-50">
                  Demande de devis
                </Button>
              </Link>
            </motion.div>
              ...
              <div className="px-4 py-6 space-y-4">
                ...
                <div className="pt-4 border-t border-gray-200 space-y-3">
                  <Link to="/login" onClick={() => setIsMobileMenuOpen(false)}>
                    <Button type="text" block className="text-gray-700 hover:text-teal-600 justify-start">
                      Connexion
                    </Button>
                  </Link>
                  <Link to="/register" onClick={() => setIsMobileMenuOpen(false)}>
                    <Button type="primary" block className="bg-teal-600 hover:bg-teal-700 border-teal-600">
                      Créer un compte
                    </Button>
                  </Link>
                  <Link to="/demande-devis" onClick={() => setIsMobileMenuOpen(false)}>
                    <Button type="default" block className="border-teal-600 text-teal-600 hover:bg-teal-50">
                      Demande de devis
                    </Button>
                  </Link>
                </div>
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            >
              EHC Formation Hub révolutionne la gestion de la formation en entreprise avec
            ...
            >
              <Link to="/register">
                <Button 
                  type="primary" 
                  size="large" 
                  className="bg-gradient-to-r from-teal-600 to-blue-600 border-0 hover:from-teal-700 hover:to-blue-700 text-white font-semibold px-8 py-4 h-auto text-lg shadow-lg hover:shadow-xl transition-all duration-300"
                >
              ...
              <Link to="/demande-devis">
                <Button 
                  size="large" 
                  className="border-2 border-teal-600 text-teal-600 hover:bg-teal-50 font-semibold px-8 py-4 h-auto text-lg shadow-lg hover:shadow-xl transition-all duration-300"
                >
                  Demande de devis
                </Button>
              </Link>
      ...
      <footer className="px-4 py-12 md:py-16 lg:py-20 md:px-8 lg:px-12 bg-gray-900 text-gray-300">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-500 text-sm">
            <p>© 2024 EHC Formation Hub. Tous droits réservés.</p>
